...
class AssertTest {
	...
	void test_assertTrue() {
		def expected = "Ken"
		def actual   = "Ken"
		com.kazurayam.webdriverfactory4ks.Assert.assertTrue(
	...
	void test_assertFalse() {
		def expected = "Ken"
		def actual   = "Merry"
		com.kazurayam.webdriverfactory4ks.Assert.assertFalse(
				"$expected truth that {expected} is ${actual}, but found false",
				expected == actual,
				FailureHandling.OPTIONAL)
	}
	...
	void test_assertEquals_String() {
		def expected = "Tom"
		def actual   = "Tom"
		com.kazurayam.webdriverfactory4ks.Assert.assertEquals(
