package com.kazurayam.thoughtfulwebdriverfactory
...
class AssertTest {
	...
	void test_assertTrue() {
		def expected = "Ken"
		def actual   = "Ken"
		com.kazurayam.thoughtfulwebdriverfactory.Assert.assertTrue(
	...
	void test_assertFalse() {
		def expected = "Ken"
		def actual   = "Merry"
		com.kazurayam.thoughtfulwebdriverfactory.Assert.assertFalse(
				"$expected truth that {expected} is ${actual}, but found false",
				expected == actual,
				FailureHandling.OPTIONAL)
	}
	...
	void test_assertEquals_String() {
		def expected = "Tom"
		def actual   = "Tom"
		com.kazurayam.thoughtfulwebdriverfactory.Assert.assertEquals(
